  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div>
          <div className="text-xs uppercase tracking-[0.18em] text-neutral-400">{dataset.countryCode ? dataset.countryCode : country}</div>
...
function GlobeVisual({ language, featuredCountries, onCountrySelect }) {
  return (
    <div className="relative overflow-hidden rounded-3xl border border-black/10 bg-[#0f2f24] p-6 text-white shadow-[0_12px_40px_rgba(0,0,0,0.14)]">
      ...
      <div className="relative">
        ...
        <h3 className="mt-2 text-2xl font-semibold tracking-tight">
          {language === 'en' ? 'Choose a country on the data map.' : '지도에서 국가를 선택해보세요.'}
        </h3>
        <p className="mt-3 max-w-md text-sm leading-6 text-white/70">
          {language === 'en'
            ? 'Click a pin to filter the archive by country or international source category.'
            : '지도 위의 핀을 클릭하면 해당 국가 또는 국제기구 데이터로 바로 이동합니다.'}
        </p>

        <div className="relative mx-auto mt-8 h-[300px] max-w-[460px] rounded-[28px] border border-white/10 bg-white/[0.04] p-4 shadow-inner">
          ...
          <svg viewBox="0 0 420 250" className="absolute inset-4 h-[calc(100%-2rem)] w-[calc(100%-2rem)] text-white/55" role="img" aria-label="Stylized world map">
            <path d="M58 88c24-27 72-28 92-7 9 10 4 21-11 24-15 4-14 16-4 26 15 15 2 33-21 28-31-7-63-28-70-48-3-9 2-17 14-23Z" fill="currentColor" opacity="0.22" />
            <path d="M112 46c24-15 58-13 78 4 12 10 11 23-1 30-18 10-58 2-82-11-13-7-11-16 5-23Z" fill="currentColor" opacity="0.16" />
            <path d="M193 83c20-12 46-15 66-7 14 6 17 18 7 29-11 11-35 13-52 7-17-7-35-19-21-29Z" fill="currentColor" opacity="0.24" />
            <path d="M254 103c29-18 88-11 111 18 18 23 5 50-31 62-31 10-72 2-89-20-17-22-14-46 9-60Z" fill="currentColor" opacity="0.18" />
            <path d="M289 57c26-9 58-5 76 11 10 9 8 20-4 26-18 8-49 2-71-12-14-9-14-19-1-25Z" fill="currentColor" opacity="0.18" />
            <path d="M205 151c21 8 29 32 18 55-8 17-24 20-37 6-14-15-20-46-9-59 6-7 16-6 28-2Z" fill="currentColor" opacity="0.14" />
            <path d="M56 202c83 25 223 25 310 0" stroke="currentColor" strokeWidth="1" opacity="0.17" fill="none" />
            <path d="M56 48c83-25 223-25 310 0" stroke="currentColor" strokeWidth="1" opacity="0.12" fill="none" />
            <path d="M40 125h340" stroke="currentColor" strokeWidth="1" opacity="0.12" />
          </svg>
          ...
          {featuredCountries.map((country) => {
            ...
            return (
              ...
              >
                <span className="absolute left-1/2 top-1/2 h-9 w-9 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/10 opacity-0 transition group-hover:scale-125 group-hover:opacity-100" />
                <span className="relative flex h-9 w-9 items-center justify-center rounded-full border border-white/30 bg-[#f7f0e3] text-xs font-bold text-[#0f2f24] shadow-[0_8px_22px_rgba(0,0,0,0.22)] transition group-hover:-translate-y-1 group-hover:bg-white">
                  {country.code}
                </span>
                <span className="pointer-events-none absolute left-1/2 top-11 hidden -translate-x-1/2 whitespace-nowrap rounded-full bg-white px-3 py-1 text-xs font-medium text-[#0f2f24] shadow-lg group-hover:block">
                  {country.name}
                </span>
              </button>
            )
        ...
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-sm leading-6 text-neutral-600 sm:text-base">
              {language === 'en'
                ? 'A quick visual summary of the sources currently collected in this archive.'
                : '현재 아카이브에 수집된 데이터 출처를 한눈에 볼 수 있도록 요약했습니다.'}
            </p>
          </div>
          ...
          <header className="border-b border-black/10 px-6 py-5 lg:px-8">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              <nav className="flex flex-wrap items-center gap-5 text-sm text-neutral-600">
                ...
                <a href="#snapshot" className="transition hover:text-black">Snapshot</a>
            ...
            <section id="browse" className="border-b border-black/10 px-6 py-16 lg:px-8 lg:py-20">
              <div className="mx-auto max-w-6xl">
                <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
                  <GlobeVisual language={language} featuredCountries={featuredCountries} onCountrySelect={handleCountryBrowse} />
                  ...
                  <div>
                    <div className="text-left">
                      ...
                      <p className="mt-3 max-w-2xl text-sm leading-6 text-neutral-600 sm:text-base">
                        {language === 'en'
                          ? 'Start with a country and move directly to official portals, surveys, panel studies, and justice-related sources.'
                          : '국가를 선택하면 공식통계, 조사자료, 패널자료, 형사사법 관련 데이터 출처를 바로 확인할 수 있습니다.'}
                      </p>
                    </div>
              ...
              <div className="mx-auto max-w-6xl">
                <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr] lg:items-start">
                  <div>
                    ...
                    <p className="mt-4 max-w-2xl text-sm leading-6 text-neutral-600 sm:text-base">
                      {language === 'en'
                        ? 'Choose search conditions first, then press Search datasets to update the results.'
                        : '검색 조건을 먼저 선택한 뒤 검색 버튼을 눌러 결과를 확인할 수 있습니다.'}
                    </p>
                    ...
                    <div className="mt-6 grid gap-4 sm:grid-cols-2">
                      ...
                      <label className="block">
                        ...
                        <select value={draftFilters.country} onChange={(event) => updateDraftFilter('country', event.target.value)} className="w-full rounded-xl border border-white/10 bg-white px-4 py-3 text-sm text-neutral-900 outline-none">
                          ...
                          <option value="__INTERNATIONAL__">International</option>
              ...
              <div className="mx-auto max-w-6xl">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                  ...
                  <span className="rounded-full border border-black/10 bg-white px-4 py-2 text-sm font-medium text-neutral-500">
                    {language === 'en' ? 'Suggestions coming later' : '데이터 제안 기능은 추후 추가'}
                  </span>
                </div>
