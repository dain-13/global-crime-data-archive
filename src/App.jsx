...
function DraggableNode({ node, position, language, isActive, onClick, onDragStart }) {
  ...
  const typeClass = {
    ...
    source: 'min-w-[132px] max-w-[190px] rounded-full border border-black/10 bg-white/95 px-3 py-2 text-xs font-medium leading-4 text-neutral-700 shadow-sm',
  }[node.type]
    ...
    activeGroup.institutions.forEach((institution, institutionIndex) => {
      ...
      if (expandedInstitutionId === institutionNodeId) {
        ...
        institution.sources.forEach((source, sourceIndex) => {
          ...
          const columns = Math.min(sourceCount, 4)
    ...
    <section id="landscape" className="border-b border-black/10 px-6 py-16 lg:px-8 lg:py-20">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-10 rounded-[28px] border border-black/10 bg-white/70 p-6 shadow-[0_12px_35px_rgba(0,0,0,0.05)]">
          ...
          <div
            ref={graphRef}
            className="relative mt-6 h-[860px] overflow-hidden rounded-[28px] border border-black/10 bg-[#f7f0e3] shadow-inner touch-none"
          >
