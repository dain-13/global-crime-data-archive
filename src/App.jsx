...
function DataLandscape({ language, onCountrySelect, onLandscapeFocus, activeLandscapeFocus }) {
  ...
  const graph = useMemo(() => {
    ...
    const layoutPresets = {
      1: [{ x: 50, y: 52 }],
      2: [{ x: 28, y: 48 }, { x: 72, y: 48 }],
      3: [{ x: 22, y: 46 }, { x: 78, y: 46 }, { x: 50, y: 62 }],
      4: [{ x: 20, y: 44 }, { x: 80, y: 44 }, { x: 31, y: 59 }, { x: 69, y: 59 }],
      5: [{ x: 18, y: 43 }, { x: 82, y: 43 }, { x: 27, y: 57 }, { x: 73, y: 57 }, { x: 50, y: 66 }],
      6: [{ x: 17, y: 43 }, { x: 83, y: 43 }, { x: 26, y: 55 }, { x: 74, y: 55 }, { x: 38, y: 66 }, { x: 62, y: 66 }],
      7: [{ x: 16, y: 42 }, { x: 84, y: 42 }, { x: 25, y: 54 }, { x: 75, y: 54 }, { x: 36, y: 64 }, { x: 64, y: 64 }, { x: 50, y: 70 }],
      8: [{ x: 15, y: 42 }, { x: 85, y: 42 }, { x: 24, y: 53 }, { x: 76, y: 53 }, { x: 34, y: 63 }, { x: 66, y: 63 }, { x: 50, y: 70 }, { x: 50, y: 55 }],
    }
