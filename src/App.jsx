...
function DataLandscape({ language, onCountrySelect, onLandscapeFocus, activeLandscapeFocus }) {
  ...
  const graph = useMemo(() => {
    ...
    const layoutPresets = {
      1: [{ x: 50, y: 48 }],
      2: [{ x: 24, y: 40 }, { x: 76, y: 40 }],
      3: [{ x: 18, y: 39 }, { x: 82, y: 39 }, { x: 50, y: 54 }],
      4: [{ x: 16, y: 37 }, { x: 84, y: 37 }, { x: 30, y: 52 }, { x: 70, y: 52 }],
      5: [{ x: 14, y: 36 }, { x: 86, y: 36 }, { x: 25, y: 50 }, { x: 75, y: 50 }, { x: 50, y: 57 }],
      6: [{ x: 13, y: 36 }, { x: 87, y: 36 }, { x: 24, y: 49 }, { x: 76, y: 49 }, { x: 38, y: 57 }, { x: 62, y: 57 }],
      7: [{ x: 12, y: 35 }, { x: 88, y: 35 }, { x: 22, y: 48 }, { x: 78, y: 48 }, { x: 34, y: 56 }, { x: 66, y: 56 }, { x: 50, y: 60 }],
      8: [{ x: 12, y: 35 }, { x: 88, y: 35 }, { x: 22, y: 47 }, { x: 78, y: 47 }, { x: 34, y: 55 }, { x: 66, y: 55 }, { x: 50, y: 60 }, { x: 50, y: 45 }],
    }
