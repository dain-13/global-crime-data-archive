...
function DataLandscape({ language, onCountrySelect, onLandscapeFocus, activeLandscapeFocus }) {
  ...
  const graph = useMemo(() => {
    ...
    const layoutPresets = {
      1: [{ x: 50, y: 56 }],
      2: [{ x: 28, y: 55 }, { x: 72, y: 55 }],
      3: [{ x: 15, y: 42 }, { x: 50, y: 62 }, { x: 85, y: 42 }],
      4: [{ x: 14, y: 36 }, { x: 35, y: 60 }, { x: 65, y: 60 }, { x: 86, y: 36 }],
      5: [{ x: 12, y: 34 }, { x: 28, y: 57 }, { x: 50, y: 64 }, { x: 72, y: 57 }, { x: 88, y: 34 }],
      6: [{ x: 12, y: 32 }, { x: 24, y: 52 }, { x: 42, y: 63 }, { x: 58, y: 63 }, { x: 76, y: 52 }, { x: 88, y: 32 }],
      7: [{ x: 11, y: 31 }, { x: 20, y: 46 }, { x: 34, y: 58 }, { x: 50, y: 65 }, { x: 66, y: 58 }, { x: 80, y: 46 }, { x: 89, y: 31 }],
      8: [{ x: 10, y: 30 }, { x: 18, y: 43 }, { x: 30, y: 56 }, { x: 43, y: 64 }, { x: 57, y: 64 }, { x: 70, y: 56 }, { x: 82, y: 43 }, { x: 90, y: 30 }],
    }
    const institutionPositions = activeGroup.institutions.map((_, index) => {
      ...
      // Fallback for countries with more than 8 institutions: distribute on a wide lower arc.
      const angle = (200 + ((140 / Math.max(institutionCount - 1, 1)) * index)) * (Math.PI / 180)
      return {
        x: 50 + Math.cos(angle) * 43,
        y: 30 - Math.sin(angle) * 34,
      }
    })
