...
function DataLandscape({ language, onCountrySelect, onLandscapeFocus, activeLandscapeFocus }) {
  ...
  const graph = useMemo(() => {
    ...
    const layoutPresets = {
      ...
      4: [{ x: 18, y: 31 }, { x: 82, y: 31 }, { x: 30, y: 66 }, { x: 70, y: 66 }],
      5: [{ x: 19, y: 27 }, { x: 81, y: 27 }, { x: 15, y: 52 }, { x: 85, y: 52 }, { x: 50, y: 73 }],
      6: [{ x: 18, y: 26 }, { x: 82, y: 26 }, { x: 13, y: 48 }, { x: 87, y: 48 }, { x: 31, y: 70 }, { x: 69, y: 70 }],
      7: [{ x: 18, y: 25 }, { x: 82, y: 25 }, { x: 12, y: 45 }, { x: 88, y: 45 }, { x: 25, y: 67 }, { x: 75, y: 67 }, { x: 50, y: 75 }],
