...
function DraggableNode({ node, position, language, isActive, onClick, onDragStart }) {
  ...
  const activeClass = isActive
    ? ' ring-2 ring-[#1f5a44] ring-offset-2 ring-offset-[#f7f0e3]'
    : ''
...
function DataLandscape({ language, onCountrySelect, onLandscapeFocus, activeLandscapeFocus }) {
  ...
  const graph = useMemo(() => {
    ...
    const layoutPresets = {
      1: [{ x: 50, y: 60 }],
      2: [{ x: 27, y: 60 }, { x: 73, y: 60 }],
      3: [{ x: 20, y: 55 }, { x: 50, y: 66 }, { x: 80, y: 55 }],
      4: [{ x: 18, y: 54 }, { x: 82, y: 54 }, { x: 31, y: 72 }, { x: 69, y: 72 }],
      5: [{ x: 17, y: 53 }, { x: 83, y: 53 }, { x: 27, y: 72 }, { x: 50, y: 79 }, { x: 73, y: 72 }],
      6: [{ x: 16, y: 53 }, { x: 84, y: 53 }, { x: 29, y: 70 }, { x: 71, y: 70 }, { x: 42, y: 82 }, { x: 58, y: 82 }],
      7: [{ x: 15, y: 52 }, { x: 85, y: 52 }, { x: 25, y: 68 }, { x: 75, y: 68 }, { x: 37, y: 81 }, { x: 63, y: 81 }, { x: 50, y: 88 }],
      8: [{ x: 14, y: 52 }, { x: 86, y: 52 }, { x: 24, y: 68 }, { x: 76, y: 68 }, { x: 35, y: 81 }, { x: 65, y: 81 }, { x: 50, y: 88 }, { x: 50, y: 60 }],
    }
      ...
      <div className="mx-auto max-w-6xl">
              ...
              return (
                <button
                  ...
                  className={`rounded-full border px-4 py-2 text-sm font-medium transition ${isActive
                    ? 'border-[#1f5a44] bg-[#1f5a44] text-white active:bg-[#1f5a44] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1f5a44]/35'
        ...
        <div className="mt-10 rounded-[28px] border border-black/10 bg-white/70 p-6 shadow-[0_12px_35px_rgba(0,0,0,0.05)]">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className={`rounded-xl px-4 py-3 text-sm font-semibold transition ${activeLandscapeButton === 'country'
                  ? 'bg-[#1f5a44] text-white hover:bg-[#174333] active:bg-[#1f5a44] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1f5a44]/35'
          ...
          >
            ...
            <div className="absolute left-4 top-4 max-w-[520px] rounded-2xl border border-black/10 bg-white/85 p-4 text-sm leading-6 text-neutral-600 shadow-sm">
            ...
            >
              ...
              <div className="relative mx-auto max-w-4xl text-center">
                ...
                <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
                  <a
                    href="#filters"
                    className="min-w-[150px] rounded-md bg-[#1f5a44] px-5 py-3 text-center text-sm font-medium text-white transition hover:bg-[#174333] active:bg-[#1f5a44] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1f5a44]/35"
                  >
                ...
                {hasActiveFilters && (
                  <div className="mt-8 flex flex-col gap-3 rounded-2xl border border-black/10 bg-white/75 p-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <button
                      type="button"
                      onClick={clearFilters}
                      className="rounded-xl bg-[#1f5a44] px-4 py-3 text-sm font-semibold text-white transition hover:bg-[#174333] active:bg-[#1f5a44] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1f5a44]/35"
                    >
