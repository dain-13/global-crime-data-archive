...
const RESEARCH_LABEL_EXAMPLES = [
  { en: 'Crime & criminal justice', ko: '범죄·형사사법' },
  { en: 'Addiction & substance use', ko: '중독·물질사용' },
  { en: 'Mental health', ko: '정신건강' },
  { en: 'Developmental criminology', ko: '발달범죄학' },
  { en: 'Problem behavior', ko: '문제행동' },
  { en: 'Neurophysiology', ko: '신경생리' },
]
...
function DatasetCard({ dataset, language }) {
  ...
  return (
    ...
    >
      ...
      {researchLabels?.length > 0 && (
        <div className="mt-4 flex flex-wrap gap-2">
          {researchLabels.slice(0, 3).map((tag) => (
            <span key={tag} className="rounded-full border border-[#0f2f24]/10 bg-[#f7f0e3] px-2.5 py-1 text-xs font-medium text-[#0f2f24]">
              {tag}
            </span>
          ))}
        </div>
            ...
            >
              ...
              <div className="relative mx-auto max-w-4xl text-center">
                ...
                <h1 className="mx-auto max-w-3xl text-4xl font-semibold tracking-tight text-neutral-900 sm:text-5xl lg:text-6xl">
                  {language === 'en' ? (
                    <>
                      Find crime, justice, and related research data
                      <br />
                      across countries.
                    </>
                  ) : (
                    <>
                      범죄·형사사법 연구 데이터를 중심으로
                      <br />
                      세계 각국의 관련 자료를 찾아보는 아카이브
                    </>
                  )}
                </h1>
                ...
                <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-neutral-600 sm:text-lg">
                  {language === 'en' ? (
                    <>
                      A bilingual directory centered on crime and criminal justice data,
                      <br />
                      with related sources for addiction, mental health, developmental criminology, and neurophysiology research.
                    </>
                  ) : (
                    <>
                      범죄·형사사법 데이터를 중심으로, 중독, 정신건강, 발달범죄학,
                      <br />
                      문제행동, 신경생리 연구에 활용할 수 있는 자료까지 함께 정리합니다.
                    </>
                  )}
                </p>
                    ...
                    <div className="mt-6 grid gap-4 sm:grid-cols-2">
                      <label className="block sm:col-span-2">
                        ...
                        <input
                          ...
                          placeholder="crime, youth, addiction, mental health, neuroimaging..."
